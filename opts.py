...
def parse_opts():
    ...
    parser.add_argument('--max_caption_len', type=int, default=256, help='')
    ...
    parser.add_argument('--grad_clip', type=float, default=1., help='clip gradients at this value')
    ...
    parser.add_argument('--save_dir', type=str, default='/ssd_scratch/cvit/zk606/', help='directory to store checkpointed models')
    ...
    parser.add_argument('--learning_strategy', type=str, default='warmup_linear',choices=('warmup_linear', 'multi_step', 'warmup_cosine'))
